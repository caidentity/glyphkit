...
const tocItems = [
  ...
  { href: '#cancellation', text: 'Cancellation & Termination' },
  { href: '#modifications', text: 'Modifications to the Service' },
  { href: '#copyright', text: 'Copyright and Content Ownership' },
  { href: '#conditions', text: 'General Conditions' }
];
